...
function timeSpanToString(startDate, endDate) {
  ...
  const milliseconds = Math.floor((span - hours * 3600000 - minutes * 60000 - seconds * 1000));
...
function angleBetweenClockHands(date) {
  ...
  const res = Math.abs((hours - minutes)) < Math.abs(360 - (hours - minutes))
    ? Math.abs(hours - minutes) : Math.abs(360 - (hours - minutes));
